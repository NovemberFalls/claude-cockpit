...
4. **Build Tauri desktop installer**:
   ...
   cd /c/Code/Personal/claude-cockpit/web/frontend && TAURI_SIGNING_PRIVATE_KEY=$(cat /c/Code/.tauri/claude-cockpit.key) TAURI_SIGNING_PRIVATE_KEY_PASSWORD='cockpit2026' npx @tauri-apps/cli build
   ```
